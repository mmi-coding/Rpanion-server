...
app.get('/api/telemetryinjector', authenticateToken, (req, res) => {
  res.setHeader('Content-Type', 'application/json')
...
app.post('/api/telemetryinjectormodify', authenticateToken, [
  check('enabled').isBoolean(),
...
app.post('/api/telemetryinject', authenticateToken, [
